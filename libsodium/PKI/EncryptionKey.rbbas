...
Inherits libsodium.PKI.KeyPair
	...
	#tag Method, Flags = &h0
		Function Export(Optional Passwd As libsodium.Password) As MemoryBlock
		  ...
		  bs.Write(libsodium.Exporting.Export(Me.PrivateKey, ExportableType.CryptPrivate, Passwd))
		  bs.Close
		  Return data
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		 Shared Function Import(ExportedKey As MemoryBlock, Optional Passwd As libsodium.Password) As libsodium.PKI.EncryptionKey
		  ...
		  libsodium.Exporting.AssertType(ExportedKey, ExportableType.CryptPrivate)
